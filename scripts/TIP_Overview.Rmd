...
### box plot of mean sugar by treatment
ggplot(data = d24_f_means, aes(x= treatment, y = sugar_grams_mean, 
                         fill=treatment, color=treatment)) +
  geom_boxplot(alpha=.5, width=0.5, outliers = FALSE)+
  geom_jitter( width=.15, height=0)+
  scale_fill_manual(values=four_colors)+
...
# PDF, CDF, and KS test
multiPDF_plot(filter(d24_li, gsw >0)$gsw, 100, "all", a_palette, "gsw")+
    labs(tag="2024")
multiCDF_plot(filter(d24_li, gsw >0)$gsw, 100, "all", a_palette, "gsw")+
    labs(tag="2024")
