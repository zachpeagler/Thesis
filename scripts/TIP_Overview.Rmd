...
d23_li <- d23_li[,c(2,3,7,8,9,16,27,31,34,35,36,38,39,61,62,63,64,65,66)]
...
## 3d scatter plot of sugar grams by mass & ripeness
# 3d plot
plot_ly(x=d23_fl$ripeness, y=d23_fl$mass, z=d23_fl$logit_sugar, type="scatter3d", mode="markers", color=d23_fl$treatment)
